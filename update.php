<?php 
	...
	{
		echo "<script> alert('Patrol car $carId status has been updated to Dispatched'); window.location.href = 'search.php?message=success&carID=$carId&newStatusId=1';</script>";
	}

	else if ($updateSuccess === TRUE && $newStatusId == 2)
	{
		echo "<script> alert('Patrol car $carId status has been updated to Arrived'); window.location.href = 'search.php?message=success&carID=$carId&newStatusId=2';</script>";
	}

	else if ($updateSuccess === TRUE && $newStatusId == 3)
	{
		echo "<script> alert('Patrol car $carId status has been updated to Free'); window.location.href = 'search.php?message=success&carID=$carId&newStatusId=3';</script>";
	}

	else if ($updateSuccess === TRUE && $newStatusId == 4)
	{
		echo "<script> alert('Patrol car $carId status has been updated to Patrol'); window.location.href = 'search.php?message=success&carID=$carId&newStatusId=4';</script>";
	}
}		
?>
